...
class Mechant :
    ...
    def __init__(self, window,canvas,x,y):
        ...
        Parameters :
                ...
                self.points :  le nombre de points que rapporte le monstre
    ...
    def tir (self,on_tir) :
        ...
        if on_tir == 2 :
            ...
            boule_de_feu = pl.Projectile(self.x+2,self.y+2,self.canvas,"Image/boule_de_feu.png", 1)
