...
class player :
    ...
    def __init__(self,window, canvas):
        ...
        self.canvas = canvas
        self.window = window
        self.image = Image.open("yeti.png")
    ...
    def move_right(self, evt):
        ...
        self.__x += self.vel
        self.canvas.coords(self.yeti, self.__x+20, self.__y+20, self.__x+40, self.__y+40)
    ...
    def tir(self):
        """ déplace les projectiles et vérifie qu'ils ne soient pas sortis de l'écran, sinon on les supprimes"""
